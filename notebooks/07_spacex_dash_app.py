...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                                ...
                                                value='ALL',
                                                placeholder='Please select one launch site',
                                                searchable=True
                                                ),
                                html.Br(),
                                ...
                                dcc.RangeSlider(
                                    ...
                                    max=10000,
                                    marks={
                                        payload: {"label": str(payload), "style": {"writing-mode": "vertical-rl"}}
                                            for payload in range(0,10000, 1000)
                                    },
...
def get_pie_chart(entered_site):
    ...
    if entered_site== 'ALL':
        ...
        df = pd.DataFrame(df[['class']].value_counts()/df.shape[0]*100).reset_index()
        fig = px.pie(df, values=0, names='class',
